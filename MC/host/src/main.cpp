...
int main() {
    ...
    //I dont want to recompile the application with different values
    printf("enter max_deviation : ");
    scanf("%f",&max_deviation);
...
void mc() {
    ...
    while (1) {
        if ((i % 100 == 0) && (i != 0)) {
            printf("good_iter_hung is %d and energy is %f\n", good_iter_hung, energy_ar[good_iter-1]/N);
            good_iter_hung = 0;
        }
